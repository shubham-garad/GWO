<h1>Open GWO.cpp here!!!!!</h1>
<h4> Still need to add other fitness functions from benchmarks.cpp but yeah now it is almost done .. :) :)<br>I know it's not like professional but blame the algo for it not me</h4>
